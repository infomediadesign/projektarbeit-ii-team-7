...
public:
  ...
  std::vector<struct BackgroundJSON> get_background() { return background; };

  std::vector<struct ObjectJSON> get_objects() { return objects; };

  std::vector<struct CollisionJSON> get_collisions() { return collisions; };
